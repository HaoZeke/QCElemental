...
htmlhelp_basename = "qcelementaldoc"
...
latex_documents = [
    (master_doc, "QCElemental.tex", "QCElemental Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "qcelemental", "QCElemental Documentation", [author], 1)]
